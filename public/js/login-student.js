...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById('demo-id').addEventListener('click', () => {
    idInput.value = 'STU001'; pwInput.value = 'student123'; errorMsg.classList.remove('visible');
  });
  document.getElementById('demo-id2').addEventListener('click', () => {
    idInput.value = 'STU002'; pwInput.value = 'student123'; errorMsg.classList.remove('visible');
  });
  document.getElementById('demo-pw').addEventListener('click', () => {
    pwInput.value = 'student123';
  });
  ...
  form.addEventListener('submit', async (e) => {
    ...
    try {
      const data = await Api.loginStudent(id, password);
      saveSession(data);
